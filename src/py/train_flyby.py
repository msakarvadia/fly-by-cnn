...
def make_gru_network(drop_prob=0):
        x0 = tf.keras.Input(shape=[None, 256, 256, 6])
...
class DatasetGenerator:
    ...
    def generator(self):
        ...
        for idx, row in self.df.iterrows():
            ...
            img_np = img_np.reshape([16, 256, 256, 6])
...
#TODO change data paths
#train_df = pd.read_csv("/work/mansisak/data/Conte/sa_ct_sd_norm/sa_ct_sd_depth_norm_DL_sets/train.csv")
#valid_df = pd.read_csv("/work/mansisak/data/Conte/sa_ct_sd_norm/sa_ct_sd_depth_norm_DL_sets/val.csv")
#test_df = pd.read_csv("/work/mansisak/data/Conte/sa_ct_sd_norm/sa_ct_sd_depth_norm_DL_sets/test.csv")

train_df = pd.read_csv("/work/mansisak/data/Conte/sa_ct_sd_norm/sa_ct_depth_norm_DL_sets/train.csv")
valid_df = pd.read_csv("/work/mansisak/data/Conte/sa_ct_sd_norm/sa_ct_depth_norm_DL_sets/val.csv")
test_df = pd.read_csv("/work/mansisak/data/Conte/sa_ct_sd_norm/sa_ct_depth_norm_DL_sets/test.csv")
...
checkpoint_path = "/work/mansisak/trained_models/gru_cnn_nn_sa_ct_depth_norm"
